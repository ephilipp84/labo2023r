...
PARAM <- list()
PARAM$experimento <- 999

# Establezco la semilla aleatoria, cambiar por SU primer semilla
PARAM$semilla <- 13

#-0.52591251276468	1397	11	10 kaggle 73, seed=17

#-0.526579270661186	1106	76	6

#-0.534650874541745	1545	5	12
 #-0.999907088996404	1787	2	9
...
for (arbolito in 1:PARAM$num_trees_max) {
  ...
  num_reg_entrena<-as.integer(0.9*nrow(dtrain0))
  # Creamos una muestra aleatoria de registros de entrenamiento
  
  v_ <- sample(nrow(dtrain0), num_reg_entrena)
...
#########################################
#luego borrar todo lo de arriba de esto
