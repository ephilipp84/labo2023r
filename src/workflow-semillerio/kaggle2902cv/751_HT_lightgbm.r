...
PARAM <- list()
PARAM$experimento <- "HTkg2902cv7510"

PARAM$exp_input <- "TSkg2902cv7410"
...
PARAM$bo_lgb <- makeParamSet(
  makeNumericParam("learning_rate", lower = 0.02, upper = 0.15),
  makeNumericParam("min_gain_to_split", lower = 0.0, upper = 7.0),
