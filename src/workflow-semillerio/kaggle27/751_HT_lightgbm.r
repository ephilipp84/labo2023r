...
PARAM <- list()
PARAM$experimento <- "HTkg277510"

PARAM$exp_input <- "TSkg277410"
...
PARAM$bo_lgb <- makeParamSet(
  makeNumericParam("learning_rate", lower = 0.01, upper = 0.062656063050063),
  makeNumericParam("feature_fraction", lower = 0.097566046991732, upper = 1.0),
  makeIntegerParam("num_leaves", lower = 680L, upper = 1399L),
