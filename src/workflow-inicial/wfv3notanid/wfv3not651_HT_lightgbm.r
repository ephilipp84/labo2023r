...
PARAM <- list()
PARAM$experimento <- "WFV3notanidHT6510"

PARAM$exp_input <- "WFV3notanidTS6410"
...
PARAM$bo_lgb <- makeParamSet(
  makeNumericParam("learning_rate", lower = 0.0, upper = 0.14529730777616
),
  makeNumericParam("feature_fraction", lower = 0.749240385440429
, upper = 1.0),
  makeIntegerParam("num_leaves", lower = 512L, upper = 1536L),
  makeIntegerParam("min_data_in_leaf", lower = 0L, upper = 15980L)
)
