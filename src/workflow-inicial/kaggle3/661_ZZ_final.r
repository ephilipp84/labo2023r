...
PARAM <- list()
PARAM$experimento <- "kaggle3ZZ6610"
PARAM$exp_input <- "kaggle3HT6510"
...
PARAM$semillas <- c(558109, 558113, 558121, 558139, 558149,2,3,5,7,11)

PARAM$kaggle$envios_desde <- 10400L
