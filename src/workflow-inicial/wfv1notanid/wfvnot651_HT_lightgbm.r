...
PARAM <- list()
PARAM$experimento <- "WFVnotanidHT6510"

PARAM$exp_input <- "WFVnotanidTS6410"
...
PARAM$bo_lgb <- makeParamSet(
  makeNumericParam("learning_rate", lower = 0.01241495270264
, upper = 0.04991495270264
),
  makeNumericParam("feature_fraction", lower = 0.884022736536865
, upper = 1.0),
  makeIntegerParam("num_leaves", lower = 1271L, upper = 1399L),
  makeIntegerParam("min_data_in_leaf", lower = 0L, upper = 3816L)
)
