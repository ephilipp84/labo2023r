...
PARAM <- list()
PARAM$experimento <- "WFV2hisanidHT6510"

PARAM$exp_input <- "WFV2hisanidTS6410"
...
PARAM$bo_lgb <- makeParamSet(
  makeNumericParam("learning_rate", lower = 0.0, upper = 0.057055801074395
),
  makeNumericParam("feature_fraction", lower = 0.0, upper = 0.216727187563735
),
  makeIntegerParam("num_leaves", lower = 660L, upper = 916L),
  makeIntegerParam("min_data_in_leaf", lower = 0L, upper = 8074L)
)
