...
PARAM <- list()
PARAM$experimento <- "WFVhisaniddHT6510"

PARAM$exp_input <- "WFVhisaniddTS6410"
...
PARAM$bo_lgb <- makeParamSet(
  makeNumericParam("learning_rate", lower = 0.025156063050063
, upper = 0.062656063050063
),
  makeNumericParam("feature_fraction", lower = 0.104753490061745
, upper = 0.229753490061745
),
  makeIntegerParam("num_leaves", lower = 680L, upper = 808L),
  makeIntegerParam("min_data_in_leaf", lower = 0L, upper = 3125L)
)
