...
PARAM <- list()
PARAM$experimento <- "WFVpromHT6510"

PARAM$exp_input <- "WFVpromTS6410"
...
PARAM$bo_lgb <- makeParamSet(
  makeNumericParam("learning_rate", lower = 0.0200001043959533
, upper = 0.02122483390326
),
  makeNumericParam("feature_fraction", lower = 0.124630074959366
, upper = 0.402688064026838
),
  makeIntegerParam("num_leaves", lower = 9L, upper = 908L),
  makeIntegerParam("min_data_in_leaf", lower = 110L, upper = 8330L)
)
