...
PARAM <- list()
PARAM$experimento <- "WFVaniddHT6510"

PARAM$exp_input <- "WFVaniddTS6410"
...
PARAM$bo_lgb <- makeParamSet(
  makeNumericParam("learning_rate", lower = 0.0024905744409
, upper = 0.0399905744409
),
  makeNumericParam("feature_fraction", lower = 0.097566046991732
, upper = 0.222566046991732
),
  makeIntegerParam("num_leaves", lower = 799L, upper = 927L),
  makeIntegerParam("min_data_in_leaf", lower = 0L, upper = 6018L)
)
