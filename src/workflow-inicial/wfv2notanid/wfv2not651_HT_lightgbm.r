...
PARAM <- list()
PARAM$experimento <- "WFV2notanidHT6510"

PARAM$exp_input <- "WFV2notanidTS6410"
...
PARAM$bo_lgb <- makeParamSet(
  makeNumericParam("learning_rate", lower = 0.002900828394887
, upper = 0.077900828394887
),
  makeNumericParam("feature_fraction", lower = 0.874854200214953
, upper = 1.0),
  makeIntegerParam("num_leaves", lower = 1282L, upper = 1538L),
  makeIntegerParam("min_data_in_leaf", lower = 0L, upper = 9268L)
)
