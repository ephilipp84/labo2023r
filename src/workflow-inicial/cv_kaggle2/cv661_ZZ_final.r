...
PARAM <- list()
PARAM$experimento <- "cv_kaggle2ZZ6610"
PARAM$exp_input <- "cv_kaggle2HT6510"
...
PARAM$semillas <- c(558109, 558113, 558121, 558139, 558149, 289349, 289361, 289369, 289381, 289397)
